    ...
    return (
        <section className="categories">
            <div className="container mx-auto">
                <div className="w-full py-8 md:py-20 flex flex-col gap-10 px-4">
                    <div className="w-full flex items-center justify-center">
                        <div className="w-full flex items-center justify-center">
                            <p className="font-bold text-[28px] leading-[42px] text-center text-text">
                                <span className="block md:inline">Shop</span>
                                <span className="block md:inline"> by Categories</span>
                            </p>
                        </div>
                    </div>
                    <div className="w-full flex flex-wrap md:flex-nowrap justify-between gap-y-6">
                        {cats.map((cat) => (
                            <div key={cat.name} className="flex flex-col items-center gap-3 w-1/2 md:w-auto">
                                <Link to={cat.path}>
                                    <img src={cat.img} alt={cat.name} className="w-[130px] h-[130px] md:w-[140px] md:h-[140px] hover:scale-90 transition-transform duration-300 rounded-full object-cover" />
                                </Link>
