...
function Brands() {
    ...
    return (
        <div className="w-full">
            <div className="max-w-[1200px] h-[158px] flex flex-col gap-6 px-6 py-10 items-center justify-center mx-auto">
                <div className="w-full max-w-[1152px] h-[30px] flex items-center justify-center">
                    <p className="font-semibold h-[24px] w-[127.419px] text-[16px] leading-6 text-center text-text">
                        Trending Brands
                    </p>
                </div>
